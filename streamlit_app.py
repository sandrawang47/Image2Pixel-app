...
if uploaded_file:
    ...
    size_mode = st.radio("Canvas Size Mode", ["Custom Pixel Size - For Excel Pixel Art Tool, we recommend you select this one, and select HEX for Color Format below", "Original Size"])
